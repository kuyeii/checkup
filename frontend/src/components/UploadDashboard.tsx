...
export function UploadDashboard(props: {
  ...
  const renderMatrixSection = () => (
    <div className={`matrixSection shrink-0 ${hasFile ? 'matrixSection--uploaded' : ''}`}>
              ...
              <div className="postUploadReviewPanel" onClick={(event) => event.stopPropagation()}>
                <div className="postUploadFileRow">
                  ...
                  <div className="postUploadFileMeta">
                    ...
                    <div className="postUploadFileInfo">0.02 MB · DOCX</div>
                  </div>
                  <button
                    type="button"
                ...
                <div className="postUploadSideGrid" role="radiogroup" aria-label="审查立场选择">
